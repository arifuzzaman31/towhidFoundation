...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPhotos: function getPhotos() {
      ...
      this.isLoading = true;
      axios.get(base_url + 'get-album-photo?album_id=' + album_id).then(function (response) {
              ...
              directives: [
                {
                  ...
                  rawName: "v-lazy",
                  value:
                    _vm.url + "images/team-member-image/" + _vm.photo.image,
                  expression: "url+'images/team-member-image/'+photo.image"
                }
              ],
