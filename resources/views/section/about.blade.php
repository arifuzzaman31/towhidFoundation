        ...
        <div class="row text-justify" >
            ...
            <div class="col-xl-7 col-lg-7 col-md-7">
                <div class="video-content-inner">
                    ...
                    <p>@lang('hero_area.about_text')</p>
                </div>
            </div>
        </div>
    </div>
</section>
<section id="about" class="position-relative pt-60" style="background-image: -webkit-linear-gradient( -18deg, rgb(37, 123, 208) 0%, rgb(175, 197, 54) 100%);">
    <div class="container">
        <div class="row text-justify" >
            <div class=" col-md-5" align="center">
